...
class Chatbot(Base):
    ...
    nama_chatbot: Mapped[str] = mapped_column(String(255), nullable=False, index=True)
    otoritas: Mapped[AuthorityEnum] = mapped_column(Enum(AuthorityEnum), nullable=False)
